...
public class HeroKnight : MonoBehaviour
{
    ...
    [SerializeField] float m_wallJumpForce = 150.0f;
    ...
    void Update()
    {
        ...
        // Move
        if ((!m_rolling && m_grounded) || (!m_isWallSliding && m_grounded) || (!m_grounded && !m_isWallSliding && !m_rolling))
        ...
        {
            // Player is on the ground not next to any wall
            // Player is not currently rolling
            ...
            {
                //// If the player is on the wall for a short period of time
                //// the player can jump off the wall
                //if (m_wallJumpCooldown < 0.5f)
                //{
                Debug.Log("Wall jump possible");
                m_isWallSliding = false;
                m_animator.SetFloat("AirSpeedY", 0f);
                m_animator.SetBool("WallSlide", m_isWallSliding);
                m_animator.StopPlayback();
                m_wallSensorR1.Disable(1f);
                m_wallSensorR2.Disable(1f);
                m_body2d.AddForce(new Vector2(-m_facingDirection * m_jumpForce, m_wallJumpForce));
                ...
                //    m_wallSensorL1.Disable(0.5f);
                //    m_wallSensorL2.Disable(0.5f);
                //    m_wallJumpCooldown = 0.0f;

                //    // Jump in the opposite direction
                //    m_body2d.AddForce(new Vector2(-m_facingDirection * m_wallJumpForce, m_jumpForce * 0.4f));
                //}
                //else
